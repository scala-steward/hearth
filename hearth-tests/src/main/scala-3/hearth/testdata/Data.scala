...
object Data {
  ...
  def apply(value: Long): Data = value
  def apply(value: Float): Data = value
  def apply(value: Double): Data = value
  def apply(value: Boolean): Data = value
  def apply(value: String): Data = value
  def apply(value: List[Data]): Data = value
  def apply(value: Map[String, Data]): Data = value
