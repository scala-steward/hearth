...
trait ExprsScala2 extends Exprs { this: MacroCommonsScala2 =>
  ...
  object ValDefsCache extends ValDefsCacheModule {
    ...
    override def get22Ary[A: Type, B: Type, C: Type, D: Type, E: Type, F: Type, G: Type, H: Type, I: Type, J: Type, K: Type, L: Type, M: Type, N: Type, O: Type, P: Type, Q: Type, R: Type, S: Type, T: Type, U: Type, V: Type, W: Type, Returned: Type](cache: ValDefsCache, key: String): Option[Expr[A] => Expr[B] => Expr[C] => Expr[D] => Expr[E] => Expr[F] => Expr[G] => Expr[H] => Expr[I] => Expr[J] => Expr[K] => Expr[L] => Expr[M] => Expr[N] => Expr[O] => Expr[P] => Expr[Q] => Expr[R] => Expr[S] => Expr[T] => Expr[U] => Expr[V] => Expr[W] => Expr[Returned]] =
      cache.get[Expr[A] => Expr[B] => Expr[C] => Expr[D] => Expr[E] => Expr[F] => Expr[G] => Expr[H] => Expr[I] => Expr[J] => Expr[K] => Expr[L] => Expr[M] => Expr[N] => Expr[O] => Expr[P] => Expr[Q] => Expr[R] => Expr[S] => Expr[T] => Expr[U] => Expr[V] => Expr[W] => Expr[Returned]](new Key(key, Seq(Type[A].asUntyped, Type[B].asUntyped, Type[C].asUntyped, Type[D].asUntyped, Type[E].asUntyped, Type[F].asUntyped, Type[G].asUntyped, Type[H].asUntyped, Type[I].asUntyped, Type[J].asUntyped, Type[K].asUntyped, Type[L].asUntyped, Type[M].asUntyped, Type[N].asUntyped, Type[O].asUntyped, Type[P].asUntyped, Type[Q].asUntyped, Type[R].asUntyped, Type[S].asUntyped, Type[T].asUntyped, Type[U].asUntyped, Type[V].asUntyped, Type[W].asUntyped), Type[Returned].asUntyped))
    // format: on
