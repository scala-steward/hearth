...
trait Exprs extends ExprsCrossQuotes { this: MacroCommons =>
  ...
  implicit final class ValDefsCacheMethods(private val cache: ValDefsCache) {
    ...
    def get22Ary[A: Type, B: Type, C: Type, D: Type, E: Type, F: Type, G: Type, H: Type, I: Type, J: Type, K: Type, L: Type, M: Type, N: Type, O: Type, P: Type, Q: Type, R: Type, S: Type, T: Type, U: Type, V: Type, W: Type, Returned: Type](key: String): Option[Expr[A] => Expr[B] => Expr[C] => Expr[D] => Expr[E] => Expr[F] => Expr[G] => Expr[H] => Expr[I] => Expr[J] => Expr[K] => Expr[L] => Expr[M] => Expr[N] => Expr[O] => Expr[P] => Expr[Q] => Expr[R] => Expr[S] => Expr[T] => Expr[U] => Expr[V] => Expr[W] => Expr[Returned]] = ValDefsCache.get22Ary(cache, key)
    // format: on
